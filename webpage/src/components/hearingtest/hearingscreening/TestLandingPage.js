            ...
            <div className="bg-image">
                <div className="container float-left">
                    <div className="jumbotron bg-transparent">
                        ...
                        <div className="pt-5">
                            <NavLink to="/screening" type="button" className="btn btn-primary text-white px-4 py-2 shadow" size="lg" href="/screening">
        ...
        return (
            <div className="bg-secondary py-4 px-5">
                ...
                <div className="m-2 mt-4 text-center">
                    <NavLink to="/screening" type="button" className="btn btn-primary text-white px-4 py-2 shadow" size="lg" href="/screening">Begin Your Hearing Screening</NavLink>
                </div>
            </div>
        );
    }
